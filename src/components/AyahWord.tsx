...
export default function AyahWord({ word, onPlay }: AyahWordProps) {
  ...
  return (
    <span
      className={`
        mushaf-word inline-block cursor-pointer px-1 py-0.5 transition-all duration-200
        font-arabic text-3xl md:text-4xl text-[#2c2c2c] leading-none
        ${
          isActive
